...
$mail = sendMessageEmail($attendanceOfficers, $userEmail, 'Name:  ' . fullNameFromEmail($userEmail) . '<br>Event:  ' . getEventName($eventNo) . '<br>Reason:  ' . $reason, 'Absence Request on Gree-C-Web');
