...
<p>Please Note: This registration is not mandatory. If there is any information on this form that you are not willing to provide, you are under no obligation to do so.</p>
...
<tr><td>Are you regsitered for the class?*</td> <td id="buttons"><input type="radio" name="registration" value="1" /> Yes<br />
<input type="radio" name="registration" value="0" /> No</td></tr>
