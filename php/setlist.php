...
if (canEditEvents(getuser())) echo "<button type='button' class='btn pull-right' id='set_edit'>Edit</button>";
if (! mysql_num_rows($query))
{
	echo "<div id='set_empty'>No repertoire set for this event</div>";
	exit(0);
}
