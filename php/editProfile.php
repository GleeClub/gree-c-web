...
$query2 = mysql_query("select `enrollment` from `activeSemester` where `member` = '$email' and `semester` = '$CUR_SEM'");
if (mysql_num_rows($query2) == 0) $enr = "inactive";
else
{
...
<tr><td>Picture (URL of a picture of you):</td><td><input type="text" name="picture" value="<?php echo $res['picture']; ?>"/></td></tr>
<tr><td>Are you in the class or club?*</td> <td id="buttons"><input type="radio" name="registration" value="class" <?php if ($enr == 'class') echo "checked"; else if ($enr == 'inactive') echo "disabled" ?>/> Class<br />
<input type="radio" name="registration" value="club" <?php if ($enr == 'club') echo "checked"; else if ($enr == 'inactive') echo "disabled" ?> /> Club</td></tr>
...
<tr><td>Quote/About you:</td> <td><input type="text" name="about" value="<?php echo $res['about']; ?>"/></td></tr>
